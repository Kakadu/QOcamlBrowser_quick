...
//getHardcodedIndex: int
int AbstractModel::getHardcodedIndex() {
  CAMLparam0();
  ...
  _meth = caml_get_public_method(_camlobj, caml_hash_variant("getHardcodedIndex"));
...
extern "C" value caml_AbstractModel_hardcodedIndexChanged_cppmeth_wrapper(value _cppobj,value _x0) {
