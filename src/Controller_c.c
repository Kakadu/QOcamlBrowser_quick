...
//linkActivated: string->unit
void Controller::linkActivated(QString x0) {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,2);
  CAMLlocal1(_cca0);
  ...
  Q_ASSERT(Is_block(_camlobj));
  Q_ASSERT(Tag_val(_camlobj) == Object_tag);
  _meth = caml_get_public_method(_camlobj, caml_hash_variant("linkActivated"));
  _args[0] = _camlobj;
...
//backTo: string->int->unit
void Controller::backTo(QString x0,int x1) {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,3);
  CAMLlocal2(_cca0,_cca1);
  ...
  Q_ASSERT(Is_block(_camlobj));
  Q_ASSERT(Tag_val(_camlobj) == Object_tag);
  _meth = caml_get_public_method(_camlobj, caml_hash_variant("backTo"));
  _args[0] = _camlobj;
  _cca0 = caml_copy_string(x0.toLocal8Bit().data() );
  _args[1] = _cca0;
  _cca1 = Val_int(x1); 
...
//forwardTo: string->int->unit
void Controller::forwardTo(QString x0,int x1) {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,3);
  CAMLlocal2(_cca0,_cca1);
  ...
  Q_ASSERT(Is_block(_camlobj));
  Q_ASSERT(Tag_val(_camlobj) == Object_tag);
  _meth = caml_get_public_method(_camlobj, caml_hash_variant("forwardTo"));
  _args[0] = _camlobj;
  _cca0 = caml_copy_string(x0.toLocal8Bit().data() );
  _args[1] = _cca0;
  _cca1 = Val_int(x1); 
...
QString Controller::getDefaultLibraryPath() {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,1);
  caml_leave_blocking_section();
  ...
  Q_ASSERT(Is_block(_camlobj));
  Q_ASSERT(Tag_val(_camlobj) == Object_tag);
  _meth = caml_get_public_method(_camlobj, caml_hash_variant("getDefaultLibraryPath"));
  _ans = caml_callback2(_meth, _camlobj, Val_unit);
  caml_enter_blocking_section();
  QString cppans;
...
QString Controller::fullPath() {
  ...
  Q_ASSERT(Is_block(_camlobj));
  Q_ASSERT(Tag_val(_camlobj) == Object_tag);
  _meth = caml_get_public_method(_camlobj, caml_hash_variant("fullPath"));
  _ans = caml_callback2(_meth, _camlobj, Val_unit);
  caml_enter_blocking_section();
  QString cppans;
  cppans = QString(String_val(_ans));
...
extern "C" value caml_Controller_fullPathChanged_cppmeth_wrapper(value _cppobj,value _x0) {
  CAMLparam2(_cppobj,_x0);
  CAMLlocal1(_z0);
  caml_enter_blocking_section();
  Controller *o = (Controller*) (Field(_cppobj,0));
