#include "HistoryModel_c.h"

HistoryModel::HistoryModel() : _camlobjHolder(0) {
}
//parent: QModelIndex.t->QModelIndex.t
QModelIndex HistoryModel::parent(const QModelIndex & x0) const {
  CAMLparam0();
...
QModelIndex HistoryModel::index(int x0,int x1,const QModelIndex & x2) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,4);
...
int HistoryModel::columnCount(const QModelIndex & x0) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,2);
  CAMLlocal1(_cca0);
...
int HistoryModel::rowCount(const QModelIndex & x0) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,2);
  CAMLlocal1(_cca0);
...
bool HistoryModel::hasChildren(const QModelIndex & x0) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,2);
  CAMLlocal1(_cca0);
...
QVariant HistoryModel::data(const QModelIndex & x0,int x1) const {
  CAMLparam0();
  CAMLlocal3(_ans,_meth,_x0);
  CAMLlocalN(_args,3);
...
extern "C" value caml_HistoryModel_dataChanged_cppmeth_wrapper(value _cppobj,value _x0,value _x1) {
  CAMLparam3(_cppobj,_x0,_x1);
  CAMLlocal1(_z0);
  caml_enter_blocking_section();
  HistoryModel *o = (HistoryModel*) (Field(_cppobj,0));
  QModelIndex z0;
...
extern "C" value caml_HistoryModel_beginInsertRows_cppmeth_wrapper(value _cppobj,value _x0,value _x1,value _x2) {
...
extern "C" value caml_HistoryModel_endInsertRows_cppmeth_wrapper(value _cppobj,value _x0) {
...
extern "C" value caml_HistoryModel_beginRemoveRows_cppmeth_wrapper(value _cppobj,value _x0,value _x1,value _x2) {
  CAMLparam4(_cppobj,_x0,_x1,_x2);
  CAMLlocal1(_z0);
  caml_enter_blocking_section();
  HistoryModel *o = (HistoryModel*) (Field(_cppobj,0));
...
extern "C" value caml_HistoryModel_endRemoveRows_cppmeth_wrapper(value _cppobj,value _x0) {
  CAMLparam2(_cppobj,_x0);
  CAMLlocal1(_z0);
  caml_enter_blocking_section();
  HistoryModel *o = (HistoryModel*) (Field(_cppobj,0));
...
extern "C" value caml_HistoryModel_addRole_cppmeth_wrapper(value _cppobj,value _x0,value _x1) {
  CAMLparam3(_cppobj,_x0,_x1);
  CAMLlocal1(_z0);
  caml_enter_blocking_section();
  HistoryModel *o = (HistoryModel*) (Field(_cppobj,0));
...
extern "C" value caml_create_HistoryModel(value _dummyUnitVal) {
  CAMLparam1(_dummyUnitVal);
  CAMLlocal1(_ans);
  caml_enter_blocking_section();
  _ans = caml_alloc_small(1, Abstract_tag);
  (*((HistoryModel **) &Field(_ans, 0))) = new HistoryModel();
  caml_leave_blocking_section();
  CAMLreturn(_ans);
}
extern "C" value caml_store_value_in_HistoryModel(value _cppobj,value _camlobj) {
